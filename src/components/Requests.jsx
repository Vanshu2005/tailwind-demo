...
const Requests = () => {
  ...
  return (
    <div className='text-center my-10'>
      <h1 className='text-bold text-white text-3xl'>Connectins Requests</h1>
      ...
      {requests.map((request)=>{
        ...
        return(
        <div 
        key={_id}  className='flex  justify-between items-center m-4 p-4 border rounder-lg bg-base-300 w-2/3 mx-auto'>  
